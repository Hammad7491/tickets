          ...
          <tbody>
            @forelse($purchases as $idx => $p)
              @php
                ...
                // Controller routes (no direct /storage links)
              ...
              <tr>
                ...
                <td>
                  @if($previewUrl)
                    <div class="d-flex align-items-center gap-2">
                      {{-- Open in new tab (controller streams the image) --}}
                      ...
                      {{-- Force download (controller returns download()) --}}
                ...
                <td class="text-end">
                  <div class="btn-group" role="group" aria-label="Review">
                    {{-- Accept --}}
                    <form
